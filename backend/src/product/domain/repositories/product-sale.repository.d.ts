...
export declare abstract class ProductSaleRepository {
    abstract createProductSale(productSale: ProductSaleEntity): Promise<ProductSaleEntity>;
    ...
    abstract getTotalSaleProfit(): Promise<{
        totalProfit: number;
    }>;
}
