...
let MongoProductRepository = class MongoProductRepository {
    ...
    async updateOneProduct(id, product) {
        const toBeUpdatedProduct = await this.productModel.findByIdAndUpdate(id, product, { returnDocument: 'after' });
...
exports.MongoProductRepository = MongoProductRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(product_entity_1.ProductEntity.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], MongoProductRepository);
//# sourceMappingURL=mongo-product.repository.js.map