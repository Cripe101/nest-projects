...
export declare abstract class ProfitRepository {
    ...
    abstract getTotalProfit(): Promise<{
        totalProfit: number;
    }>;
    abstract getTotalProfitByMonth(): Promise<{
        totalProfit: number;
    }>;
    abstract getTotalProfitByDay(): Promise<{
        totalProfit: number;
    }>;
    abstract updateProfit(id: string, profit: Profit): Promise<Profit>;
    abstract deleteProfit(id: string): Promise<Profit>;
    abstract getPhoneTotalProfit(): Promise<{
        totalProfit: number;
    }>;
    abstract getGcashTotalProfit(): Promise<{
        totalProfit: number;
    }>;
}
